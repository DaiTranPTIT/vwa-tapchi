...
declare module Auth {
	...
	interface AuthContextType {
		...
		login: (data: { username: string; password: string }) => Promise<User.IRoot | undefined>;
		oauthLogin: (data: { accessToken: string; clientId: string }) => Promise<User.IRoot | undefined>;
