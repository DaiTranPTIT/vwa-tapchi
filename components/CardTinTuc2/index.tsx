    ...
    <CardTInTucWrapper>
      <div className="card">
        <Link href={`/tap-chi/${props.data?._id}`}>
          <div className="feature-image relative">
            ...
            {props.data?.thongTinXuatBan[0]?.lock && (
              <div className="tag absolute">{common("card.status")}</div>
            )}
          </div>
        </Link>
        <Link href={`/tap-chi/${props.data?._id}`}>
        ...
        <div className="metadata">
          <div className="label">{common("card.date")}</div>
          ...
          <div className="label">{common("card.pages")}</div>
          <div className="value flex items-center gap-[8px]">
            <svg
              width="11"
              height="14"
          ...
          <div className="label">{common("card.views")}</div>
          <div className="value flex items-center gap-[8px]">
            <svg
              width="13"
              height="8"
