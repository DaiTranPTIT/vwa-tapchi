export const dataNavBar: {
  linkTo: string;
  name: string;
  childrenRouter: { linkTo: string; name: string }[];
}[] = [
  {
    linkTo: "/",
    name: "Trang chủ",
...
export const dataCTDaoTao = [
  {
    ...
    description:
      "Ngày 3/3/2023, tại Sơn La, Công đoàn TT&TT Việt Nam tổ chức Hội nghị sơ kết phong trào thi ...",
...
export const dataNghienCuu = [
  {
    no: "01.",
    title:
      "Công nghệ thông tin, an toàn thông tin, điện tử, viễn thông, đa phương tiện",
    content:
...
export const dataQuyChe = [
  {
    ...
    trichYeu:
      "Ban hành Chiến lược phát triển khoa học, công nghệ và đổi mới sáng tạo đến năm 2030",
...
export const navMenu = [
  ...
  },
  {
    ...
    trangCon: [
      ...
      {
        id: 18,
        ten: "Tôn chỉ, Mục đích hoạt động",
