    ...
    <FooterWrapper>
      <div className="footer-container">
        ...
        <div className="copyright container mx-auto">
          ...
          <strong>
            Phòng 1503, Tầng 15, Tòa A2, Học viện Phụ nữ Việt Nam, 68 Nguyễn Chí
          ...
          <div className="contact-info">
            <p>
              Tạp chí Khoa học Học viện Phụ nữ Việt Nam đang trong quá trình
              hoàn thiện, phát triển. Mọi ý kiến đóng góp, chia sẻ xin vui lòng
              gửi về:
            </p>
